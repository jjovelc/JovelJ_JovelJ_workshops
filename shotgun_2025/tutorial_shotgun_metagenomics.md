...
After transfering file `files2transfer.zip` to the local computer and decompressing it, you should see the following content. Even for Windows users, I now recommend you install Rstudio, and do all the subsequent work there.

Figure 10. Content of the local shotgun2025 directory to start postprocessing count data (whether using a GUI explorer or a terminal, respectively).
<div align="center">
...
Open the script in Rstudio and change your working directory and root name of your input files, as shown in the following two images.

Figure 11. Set up your working directory. (for windows users, it will look something like this: `C:\Users\juanjovel\OneDrive\shotgun2025`.
<div align="center">
  <img src="images/12_change_working_directory.png" alt="Set working directory" width="600">
</div>

Figure 12. Set up root names of input files (one per taxonomic level)
<div align="center">
  <img src="images/12_change_input_file_name.png" alt="Set input files names" width="600">
</div>

Run the whole script simply by pressing CMD+SHIFT+ENTER in Mac, or CTRL+SHIFT+ENTER in Windows. The generated result files should look like this:

Figure 13. Results (plots) generated by script 12.
<div align="center">
  <img src="images/12_results_generated_by_script12.png" alt="Results generated by script 12" width="600">
</div>

As can be seen, there is three blocks of plots generated: Alpha diversity, beta diversity and stacked barplots. Here after some examples.

Figure 12. Example figures generated for script 12. From left to right, alpha diversity, beta diversity and stacked barplots. 
<div align="center">
  <img src="images/12_alpha-diversity.png" alt="Alpha diversity" width="250" style="display: inline-block;">
  <img src="images/12_beta-diversity.png" alt="Beta diversity" width="250" style="display: inline-block;">
  <img src="images/12_stacked-bar-plot.png" alt="Stacked barplot" width="250" style="display: inline-block;">
</div>
