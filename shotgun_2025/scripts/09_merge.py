...
# =================================================================#
# Merge script: from MetaPhlAn output on single sample to a joined #
# "clades vs samples" table                                        #
# Authors: Timothy Tickle (ttickle@hsph.harvard.edu) and           #  
# Curtis Huttenhower (chuttenh@hsph.harvard.edu)                   # 
# =================================================================#

# If script does not run properly, install the required python modules
